...
//弹出框登录
function login_dialog_pm(){
    CUR_DIALOG = ajax_form('login','登录','http://pm.96567.com/index.php?act=login&inajax=1',360,1);
}
    ...
    $.fn.nc_region = function(options) {
        ...
        function loadAreaArray(callback) {
            if(typeof nc_a === 'undefined') {
                ...
                if(!!area_scripts_src == false){
                    area_scripts_src = SITEURL + '/data/resource/js/jquery.js';
                }
